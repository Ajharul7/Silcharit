...
<head>
	...
	?>
	<title>Silcharit-AnimalRescue</title>
	<meta charset="utf-8">
...
<div class="row">
<center><h1 style="font-family: Bebas Neue;color: white;text-shadow: 4px 4px 1px black;"> AnimalRescue </h1></center>
	<div class='move'>
	<br><br><div id="insert_post" class="col-sm-9">
		<!-- <center> -->
		<form action="animalrescue.php?id=<?php echo $user_id; ?>" method="post" id="f" enctype="multipart/form-data">
		...
		<button id="btn-post" class="btn btn-info btn-lg" name="sub1">Post</button><br><br>
		</form>
		<?php insertPosts(); ?>
		<!-- </center> -->
	</div>
