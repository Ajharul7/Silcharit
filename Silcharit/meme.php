...
<div class="row">
<center><h1 style="font-family: Bebas Neue;color: white;text-shadow: 4px 4px 1px black;"> Memes </h1></center>
	<div class='move'>
	<br><br><div id="insert_post" class="col-sm-9">
		<!-- <center> -->
		<form action="meme.php?id=<?php echo $user_id; ?>" method="post" id="f" enctype="multipart/form-data">
		...
		<button id="btn-post" class="btn btn-info btn-lg" name="sub2">Post</button><br><br>
		</form>
		<?php insertPost2(); ?>
		<!-- </center> -->
	</div>
