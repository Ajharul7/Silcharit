...
include("includes/connection.php");
	...
	if(isset($_POST['sign_up'])){
		...
		$profile_pic = "default_cover1.jpg";
		...
		values('$first_name','$last_name','$username','HI','F','$pass','$email','$country','$gender','$birthday','$profile_pic','default_cover.jpg',NOW(),'$status','$posts','I')";
