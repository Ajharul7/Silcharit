				...
				if($p_id != $post_id) {
					...
					if($content=="No" && strlen($upload_image) >= 1){
						...
						<div class='row'>
							...
							<div id='posts1' class='col-sm-6'>
								<div class='row'>
									<div class='col-sm-2'>
									<p><img src='users/$user_image' class='img-circle' width='97px' height='97px'></p>
									</div>
									<div class='col-sm-6'>
										<h3 class='hi2'><a style='text-decoration:none; cursor:pointer;color #3897f0;' href='user_profile.php?u_id=$user_id'>$user_name</a></h3>
										<h4 id='hi3'><small style='color:black;'>Updated a post on <strong>$post_date</strong></small></h4>
									</div>
									<div class='col-sm-4'>
									</div>
								</div><br>
